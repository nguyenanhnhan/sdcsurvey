						...
						<div class="box box-color box-bordered">
							...
							<div class="box-content nopadding">
								...
								<form action="<?php echo base_url('report/export_sum_survey') ?>" method="post" class="form-horizontal form-bordered">
									...
									<div class="control-group">
										<div class="controls">
											<select name="a_sum_working" id="a_sum_working" class="chosen-select span12" data-placeholder="Chọn mẫu trả lời [Có việc làm]" data-nosearh="true">
											</select>
										</div>
									</div>
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="sum_questions[]" id="sum_question" class='chosen-select span12' multiple="multiple" data-placeholder="Chọn các câu hỏi cần kết xuất dữ liệu">
											</select>
										</div>
									</div>
									<div class="control-group">
