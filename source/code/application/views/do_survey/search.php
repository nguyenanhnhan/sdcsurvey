...
<body>
	...
	<div style="padding-left:5px">
		...
		<div><a href="<?php echo base_url("do_survey/home/".$survey_id."/".$student_item["student_id"]) ?>"><?php echo $student_item["student_id"]."|".$student_item["first_name"]."|".$student_item["last_name"]."|".$student_item["class_id"] ?></a></div>
		<?php } // end foreach ?>
		<?php } // end if?>
	</div>
</body>
