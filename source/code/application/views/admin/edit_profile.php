											...
											<form action="#" class="form-horizontal">
												...
												<div class="span10">
													<div class="control-group">
														<label for="user_name" class="control-label right">Tên tài khoản</label>
														<div class="controls">
															<div class="input-xlarge uneditable-input">nguyenanhnhan</div>
														</div>
													</div>
													<div class="control-group">
														<label for="first_name" class="control-label right">Họ:</label>
														<div class="controls">
															<input type="text" name="first_name" class='input-xlarge' value="Nguyễn Ảnh">
														</div>
													</div>
													<div class="control-group">
														<label for="last_name" class="control-label right">Tên:</label>
														<div class="controls">
													...
													<div class="control-group">
														<label for="password" class="control-label right">Mật khẩu:</label>
														<div class="controls">
