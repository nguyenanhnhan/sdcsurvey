			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo base_url('admin/survey_types') ?>">Quản trị Biểu mẫu khảo sát</a>
						</li>
					</ul>
									...
									<tbody>
										...
										<tr>
											<td>
												...
												<a href="<?php echo base_url('survey_type/view/'.$stype_item['survey_type_id']); ?>" class="btn btn-success"><i class="icon-eye-open"></i></a>
											</td>
