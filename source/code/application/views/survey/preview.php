...
<body>
	<div id="form_wrapper">
		...
		<div class="roundcont">
			...
			<form class="form" name="form_question_answer">
				...
				for ($i=0,$len_q=count($survey_question);$i<$len_q;$i++)
				{
					$question_num=$i+1;
				?>
				<div id="<?php echo $survey_question[$i]['question_id'] ?>" class="Container">
		...
		<!-- DONG DE NGHI -->
		<div class="lastbox">* Anh/Chị vui lòng kiểm tra lại thông tin sau đó click chọn "Đồng ý" để hoàn thành phiếu khảo sát.</div>	
		<form class="formEnd">
