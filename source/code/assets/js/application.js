...
$('body').on('click',".change-input", function(e){
    ...
    $el.addClass("btn-satgreen update-input").removeClass("btn-grey-4 change-input").text("Cập nhật");
});
...
$('body').on("click", '.update-input', function(e){
    ...
    setTimeout(function(){
        ...
        $parent.prev().slideUp(200, function(){
            $parent.prev().remove();
            $el.removeClass("update-input btn-satgreen").addClass("btn-grey-4 change-input").text("Cập nhật");
        });
    }, 1000);
});
